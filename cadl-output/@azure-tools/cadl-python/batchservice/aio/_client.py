...
class BatchServiceClient:  # pylint: disable=client-accepts-api-version-keyword
    """A client for issuing REST requests to the Azure Batch service.

    :ivar file: FileOperations operations
    :vartype file: batchservice.aio.operations.FileOperations
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        self._config = BatchServiceClientConfiguration(**kwargs)
